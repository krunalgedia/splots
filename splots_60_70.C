...
void AddModel(RooWorkspace* ws)
{
    ...
    RooRealVar Jet_pt("Jet_pt","Jet_pt",60,70);
...
//Make TTrees of the datasets used
    ...
    TFile* qreg_file = new TFile("qreg_file_60_70.root","RECREATE");
...
//    gPad->SetTicky();
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_60_70/splots/";
    string ud1 = "_1";
    string ud2 = "_2";
    string png = ".png";
    string compo;
...

{
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_60_70/sweights/";
    string png = ".png";
    string compo;
...

{
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_60_70/bdt_sweights/";
    string png = ".png";
    string compo;
