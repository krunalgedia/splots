...
void splots_tree_mc()
{
    ...
    datatree->SetBranchAddress("BDT_response",&iBDT_response);
    datatree->SetBranchAddress("jet_pt",&ijet_pt);
    datatree->SetBranchAddress("njet",&injet);
    datatree->SetBranchAddress("Jet_mcFlavour", iJet_mcFlavour, &ib_Jet_mcFlavour);
    datatree->SetBranchAddress("jet_indices",&ijet_indices);

    TFile *outputFile = TFile::Open("TMVA_output_splots.root", "RECREATE" );
    ...
    TBranch *nBDT_response_20 = splots_tree->Branch("BDT_response_20",&BDT_response_20);
    TBranch *nBDT_response_30 = splots_tree->Branch("BDT_response_30",&BDT_response_30);
    TBranch *nBDT_response_40 = splots_tree->Branch("BDT_response_40",&BDT_response_40);
    TBranch *nBDT_response_60 = splots_tree->Branch("BDT_response_60",&BDT_response_60);
    TBranch *nBDT_response_80 = splots_tree->Branch("BDT_response_80",&BDT_response_80);
    TBranch *nBDT_response_100 = splots_tree->Branch("BDT_response_100",&BDT_response_100);
    TBranch *nBDT_response_120 = splots_tree->Branch("BDT_response_120",&BDT_response_120);
    TBranch *njet_pt = splots_tree->Branch("jet_pt",&jet_pt);
    TBranch *njet_indices = splots_tree->Branch("jet_indices",&jet_indices);
    TBranch *nJet_mcFlavour = splots_tree->Branch("Jet_mcFlavour",&Jet_mcFlavour);
    ...
    TH1F *p_b_bdt = new TH1F("p_b_bdt" ,"bjet BDT" ,100 , -1, 1);
    TH1F *p_n_bdt = new TH1F("p_n_bdt" ,"non-bjet BDT" ,100 , -1, 1);

    TH1F *p_20_bdt = new TH1F("p_20_bdt" ,"jet BDT pt_20_30" ,100 , -1, 1);
    TH1F *p_b_20_bdt = new TH1F("p_b_20_bdt" ,"bjet BDT pt_20_30" ,100 , -1, 1);
    TH1F *p_n_20_bdt = new TH1F("p_n_20_bdt" ,"non-bjet BDT pt_20_30" ,100 , -1, 1);
    TH1F *p_30_bdt = new TH1F("p_30_bdt" ,"jet BDT pt_30_40" ,100 , -1, 1);
    TH1F *p_b_30_bdt = new TH1F("p_b_30_bdt" ,"bjet BDT pt_30_40" ,100 , -1, 1);
    TH1F *p_n_30_bdt = new TH1F("p_n_30_bdt" ,"non-bjet BDT pt_30_40" ,100 , -1, 1);
    TH1F *p_40_bdt = new TH1F("p_40_bdt" ,"jet BDT pt_40_60" ,100 , -1, 1);
    TH1F *p_b_40_bdt = new TH1F("p_b_40_bdt" ,"bjet BDT pt_40_60" ,100 , -1, 1);
    TH1F *p_n_40_bdt = new TH1F("p_n_40_bdt" ,"non-bjet BDT pt_40_60" ,100 , -1, 1);
    TH1F *p_60_bdt = new TH1F("p_60_bdt" ,"jet BDT pt_60_80" ,100 , -1, 1);
    TH1F *p_b_60_bdt = new TH1F("p_b_60_bdt" ,"bjet BDT pt_60_80" ,100 , -1, 1);
    TH1F *p_n_60_bdt = new TH1F("p_n_60_bdt" ,"non-bjet BDT pt_60_80" ,100 , -1, 1);
    TH1F *p_80_bdt = new TH1F("p_80_bdt" ,"jet BDT pt_80_100" ,100 , -1, 1);
    TH1F *p_b_80_bdt = new TH1F("p_b_80_bdt" ,"bjet BDT pt_80_1000" ,100 , -1, 1);
    TH1F *p_n_80_bdt = new TH1F("p_n_80_bdt" ,"non-bjet BDT pt_80_100" ,100 , -1, 1);
    TH1F *p_100_bdt = new TH1F("p_100_bdt" ,"jet BDT pt_100_120" ,100 , -1, 1);
    TH1F *p_b_100_bdt = new TH1F("p_b_100_bdt" ,"bjet BDT pt_100_120" ,100 , -1, 1);
    TH1F *p_n_100_bdt = new TH1F("p_n_100_bdt" ,"non-bjet BDT pt_100_120" ,100 , -1, 1);
    TH1F *p_120_bdt = new TH1F("p_120_bdt" ,"jet BDT pt_>120" ,100 , -1, 1);
    TH1F *p_b_120_bdt = new TH1F("p_b_120_bdt" ,"bjet BDT pt_>120" ,100 , -1, 1);
    TH1F *p_n_120_bdt = new TH1F("p_n_120_bdt" ,"non-bjet BDT pt_>120" ,100 , -1, 1);
    ...
    for (Long64_t ientry=0; ientry < nentries; ientry++)
    {
        ...
        for (Int_t i = 0; i < injet;i++)
        {
            ...
            p_bdt->Fill(BDT_response);
            jet_pt = (*ijet_pt)[i];
            jet_indices = (*ijet_indices)[i];
            Jet_mcFlavour = iJet_mcFlavour[jet_indices];
	    ...
	    Jet_ptd = iJet_ptd[jet_indices];
            ...
            int idx = (*ijet_indices)[i];

            if(fabs((iJet_mcFlavour)[idx]) == 5)
            {
                p_b_bdt->Fill((*iBDT_response)[i]);
            }

            else
            {
                p_n_bdt->Fill((*iBDT_response)[i]);
            }
            ...
            {  
                ...
                if(fabs((iJet_mcFlavour)[idx]) == 5)
                {
                    p_b_20_bdt->Fill((*iBDT_response)[i]);
                }
                 
                else
                {  
                    p_n_20_bdt->Fill((*iBDT_response)[i]);
                }
            }
            ...
            if(((*ijet_pt)[i]>=30) && ((*ijet_pt)[i]<40))
            {
                ...
                if(fabs((iJet_mcFlavour)[idx]) == 5)
                {
                      p_b_30_bdt->Fill(BDT_response_30);
                }
                    
                else   
                {
                      p_n_30_bdt->Fill(BDT_response_30);
                }
            }
            ...
            if(((*ijet_pt)[i]>=40) && ((*ijet_pt)[i]<60))
            {
                ...
                if(fabs((iJet_mcFlavour)[idx]) == 5)
                {
                    p_b_40_bdt->Fill((*iBDT_response)[i]);
                }
                    
                else   
                {
                    p_n_40_bdt->Fill((*iBDT_response)[i]);
                }
            }
            ...
            if(((*ijet_pt)[i]>=60) && ((*ijet_pt)[i]<80))
            {
                ...
                if(fabs((iJet_mcFlavour)[idx]) == 5)
                {
                    p_b_60_bdt->Fill((*iBDT_response)[i]);
                }
                    
                else   
                {
                    p_n_60_bdt->Fill((*iBDT_response)[i]);
                }
            }
            ...
            if(((*ijet_pt)[i]>=80) && ((*ijet_pt)[i]<100))
            {
                ...
                if(fabs((iJet_mcFlavour)[idx]) == 5)
                {
                    p_b_80_bdt->Fill((*iBDT_response)[i]);
                }
                    
                else   
                {
                    p_n_80_bdt->Fill((*iBDT_response)[i]);
                }
            }
           ...
           if(((*ijet_pt)[i]>=100) && ((*ijet_pt)[i]<120))
            {
                ...
                if(fabs((iJet_mcFlavour)[idx]) == 5)
                {
                    p_b_100_bdt->Fill((*iBDT_response)[i]);
                }

                else
                {
                    p_n_100_bdt->Fill((*iBDT_response)[i]);
                }
            }      
           ...
           if((*ijet_pt)[i]>=120)
            {
                ...
                if(fabs((iJet_mcFlavour)[idx]) == 5)
                {
                    p_b_120_bdt->Fill((*iBDT_response)[i]);
                }

                else
                {
                    p_n_120_bdt->Fill((*iBDT_response)[i]);
                }
            }
            splots_tree->Fill();
        }
