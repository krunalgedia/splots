...
// Sat Mar 17 11:03:14 2018 by ROOT version 6.06/01
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: /eos/cms/store/group/phys_higgs/vbfHbb/V25/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/VHBB_HEPPY_V25_energyRings/180312_125843/0000/tree_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           GenNu_isPromptHard[3];   //[nGenNu]
   ...
   Int_t           GenNu_motherId[3];   //[nGenNu]
   Int_t           GenNu_grandmotherId[3];   //[nGenNu]
   Int_t           GenNu_sourceId[3];   //[nGenNu]
   ...
   Int_t           GenHadTaus_isPromptHard[3];   //[nGenHadTaus]
   ...
   Float_t         FatjetCA15pruned_pt[8];   //[nFatjetCA15pruned]
   Float_t         FatjetCA15pruned_eta[8];   //[nFatjetCA15pruned]
   Float_t         FatjetCA15pruned_phi[8];   //[nFatjetCA15pruned]
   Float_t         FatjetCA15pruned_mass[8];   //[nFatjetCA15pruned]
   ...
   Float_t         FatjetCA15softdropz2b1filt_pt[8];   //[nFatjetCA15softdropz2b1filt]
   Float_t         FatjetCA15softdropz2b1filt_eta[8];   //[nFatjetCA15softdropz2b1filt]
   Float_t         FatjetCA15softdropz2b1filt_phi[8];   //[nFatjetCA15softdropz2b1filt]
   Float_t         FatjetCA15softdropz2b1filt_mass[8];   //[nFatjetCA15softdropz2b1filt]
   Int_t           ntrgObjects_hltDoublePFCentralJetLooseID90;
   Int_t           nGenJet;
   Float_t         GenJet_charge[25];   //[nGenJet]
   Int_t           GenJet_status[25];   //[nGenJet]
   Int_t           GenJet_isPromptHard[25];   //[nGenJet]
   Int_t           GenJet_pdgId[25];   //[nGenJet]
   Float_t         GenJet_pt[25];   //[nGenJet]
   Float_t         GenJet_eta[25];   //[nGenJet]
   Float_t         GenJet_phi[25];   //[nGenJet]
   Float_t         GenJet_mass[25];   //[nGenJet]
   Int_t           GenJet_numBHadrons[25];   //[nGenJet]
   Int_t           GenJet_numCHadrons[25];   //[nGenJet]
   Int_t           GenJet_numBHadronsFromTop[25];   //[nGenJet]
   Int_t           GenJet_numCHadronsFromTop[25];   //[nGenJet]
   Int_t           GenJet_numBHadronsAfterTop[25];   //[nGenJet]
   Int_t           GenJet_numCHadronsAfterTop[25];   //[nGenJet]
   Float_t         GenJet_wNuPt[25];   //[nGenJet]
   Float_t         GenJet_wNuEta[25];   //[nGenJet]
   Float_t         GenJet_wNuPhi[25];   //[nGenJet]
   Float_t         GenJet_wNuM[25];   //[nGenJet]
   Int_t           nGenVbosons;
   ...
   Float_t         FatjetCA15trimmed_pt[8];   //[nFatjetCA15trimmed]
   Float_t         FatjetCA15trimmed_eta[8];   //[nFatjetCA15trimmed]
   Float_t         FatjetCA15trimmed_phi[8];   //[nFatjetCA15trimmed]
   Float_t         FatjetCA15trimmed_mass[8];   //[nFatjetCA15trimmed]
   ...
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_pt[4];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_eta[4];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_phi[4];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Float_t         trgObjects_hltBTagCaloCSVp026DoubleWithMatching_mass[4];   //[ntrgObjects_hltBTagCaloCSVp026DoubleWithMatching]
   Int_t           naLeptons;
   ...
   Float_t         FatjetCA15softdropfilt_pt[8];   //[nFatjetCA15softdropfilt]
   Float_t         FatjetCA15softdropfilt_eta[8];   //[nFatjetCA15softdropfilt]
   Float_t         FatjetCA15softdropfilt_phi[8];   //[nFatjetCA15softdropfilt]
   Float_t         FatjetCA15softdropfilt_mass[8];   //[nFatjetCA15softdropfilt]
   Int_t           nl1Muons;
   ...
   Int_t           selLeptons_mediumIdPOG_ICHEP2016[8];   //[nselLeptons]
   ...
   Float_t         selLeptons_relIsoAn04[8];   //[nselLeptons]
   ...
   Int_t           selLeptons_convVetoFull[8];   //[nselLeptons]
   Float_t         selLeptons_eleMVArawSpring15Trig[8];   //[nselLeptons]
   Int_t           selLeptons_eleMVAIdSpring15Trig[8];   //[nselLeptons]
   Float_t         selLeptons_eleMVArawSpring15NonTrig[8];   //[nselLeptons]
   Int_t           selLeptons_eleMVAIdSpring15NonTrig[8];   //[nselLeptons]
   Float_t         selLeptons_eleMVArawSpring16GenPurp[8];   //[nselLeptons]
   Int_t           selLeptons_eleMVAIdSppring16GenPurp[8];   //[nselLeptons]
   Float_t         selLeptons_nStations[8];   //[nselLeptons]
   Float_t         selLeptons_trkKink[8];   //[nselLeptons]
   Float_t         selLeptons_segmentCompatibility[8];   //[nselLeptons]
   ...
   Float_t         selLeptons_mvaTTHjetPtRatio[8];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetBTagCSV[8];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetDR[8];   //[nselLeptons]
   ...
   Float_t         selLeptons_dr03TkSumPt[8];   //[nselLeptons]
   Float_t         selLeptons_eleEcalClusterIso[8];   //[nselLeptons]
   Float_t         selLeptons_eleHcalClusterIso[8];   //[nselLeptons]
   Float_t         selLeptons_miniIsoCharged[8];   //[nselLeptons]
   Float_t         selLeptons_miniIsoNeutral[8];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetPtRel[8];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetNDauChargedMVASel[8];   //[nselLeptons]
   Float_t         selLeptons_uncalibratedPt[8];   //[nselLeptons]
   Float_t         selLeptons_SF_IsoLoose[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IsoLoose[8];   //[nselLeptons]
   Float_t         selLeptons_SF_IsoTight[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IsoTight[8];   //[nselLeptons]
   Float_t         selLeptons_SF_IdCutLoose[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdCutLoose[8];   //[nselLeptons]
   Float_t         selLeptons_SF_IdCutTight[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdCutTight[8];   //[nselLeptons]
   Float_t         selLeptons_SF_IdMVALoose[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdMVALoose[8];   //[nselLeptons]
   Float_t         selLeptons_SF_IdMVATight[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdMVATight[8];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunD4p3[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunD4p3[8];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunD4p2[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunD4p2[8];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunC[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunC[8];   //[nselLeptons]
   Float_t         selLeptons_SF_trk_eta[8];   //[nselLeptons]
   Float_t         selLeptons_SFerr_trk_eta[8];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunD4p3[8];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunD4p3[8];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunD4p2[8];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunD4p2[8];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunC[8];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunC[8];   //[nselLeptons]
   ...
   Int_t           TauGood_idMVArun2[11];   //[nTauGood]
   Float_t         TauGood_rawMVArun2[11];   //[nTauGood]
   Int_t           TauGood_idMVArun2dR03[11];   //[nTauGood]
   Float_t         TauGood_rawMVArun2dR03[11];   //[nTauGood]
   Int_t           TauGood_idMVArun2NewDM[11];   //[nTauGood]
   Float_t         TauGood_rawMVArun2NewDM[11];   //[nTauGood]
   Int_t           TauGood_idCI3hit[11];   //[nTauGood]
   Int_t           TauGood_idAntiMu[11];   //[nTauGood]
   Int_t           TauGood_idAntiErun2[11];   //[nTauGood]
   Float_t         TauGood_isoCI3hit[11];   //[nTauGood]
   Float_t         TauGood_photonOutsideSigCone[11];   //[nTauGood]
   ...
   Int_t           TauGood_idxJetMatch[11];   //[nTauGood]
   Int_t           TauGood_genMatchType[11];   //[nTauGood]
   ...
   Float_t         FatjetCA15softdropz2b1_pt[8];   //[nFatjetCA15softdropz2b1]
   Float_t         FatjetCA15softdropz2b1_eta[8];   //[nFatjetCA15softdropz2b1]
   Float_t         FatjetCA15softdropz2b1_phi[8];   //[nFatjetCA15softdropz2b1]
   Float_t         FatjetCA15softdropz2b1_mass[8];   //[nFatjetCA15softdropz2b1]
   Float_t         FatjetCA15softdropz2b1_tau1[8];   //[nFatjetCA15softdropz2b1]
   Float_t         FatjetCA15softdropz2b1_tau2[8];   //[nFatjetCA15softdropz2b1]
   Float_t         FatjetCA15softdropz2b1_tau3[8];   //[nFatjetCA15softdropz2b1]
   ...
   Float_t         httCandidates_pt[8];   //[nhttCandidates]
   Float_t         httCandidates_eta[8];   //[nhttCandidates]
   Float_t         httCandidates_phi[8];   //[nhttCandidates]
   Float_t         httCandidates_mass[8];   //[nhttCandidates]
   Float_t         httCandidates_ptcal[8];   //[nhttCandidates]
   Float_t         httCandidates_etacal[8];   //[nhttCandidates]
   Float_t         httCandidates_phical[8];   //[nhttCandidates]
   Float_t         httCandidates_masscal[8];   //[nhttCandidates]
   Float_t         httCandidates_fRec[8];   //[nhttCandidates]
   Float_t         httCandidates_Ropt[8];   //[nhttCandidates]
   Float_t         httCandidates_RoptCalc[8];   //[nhttCandidates]
   Float_t         httCandidates_ptForRoptCalc[8];   //[nhttCandidates]
   Float_t         httCandidates_subjetIDPassed[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1ptcal[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1pt[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1eta[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1phi[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1masscal[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1mass[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1btag[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1corr[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2ptcal[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2pt[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2eta[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2phi[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2masscal[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2mass[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2btag[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2corr[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWptcal[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWpt[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWeta[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWphi[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWmasscal[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWmass[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWbtag[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonWcorr[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteStatUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteStatDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteScaleUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteScaleDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteFlavMapUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteFlavMapDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteMPFBiasUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_AbsoluteMPFBiasDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FragmentationUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FragmentationDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SinglePionECALUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SinglePionECALDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SinglePionHCALUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SinglePionHCALDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorQCDUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorQCDDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimePtEtaUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimePtEtaDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeJEREC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeJEREC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeJEREC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeJEREC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeJERHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeJERHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtBBUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtBBDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtEC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtEC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtEC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtEC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativePtHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeBalUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeBalDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeFSRUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeFSRDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeStatFSRUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeStatFSRDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeStatECUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeStatECDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeStatHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_RelativeStatHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpDataMCUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpDataMCDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtRefUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtRefDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtBBUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtBBDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtEC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtEC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtEC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtEC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpPtHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpMuZeroUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpMuZeroDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpEnvelopeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_PileUpEnvelopeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalPileUpUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalPileUpDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalRelativeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalRelativeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalPtUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalPtDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalScaleUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalScaleDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalAbsoluteUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalAbsoluteDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalMCUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_SubTotalMCDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalNoFlavorUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalNoFlavorDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalNoTimeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalNoTimeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalNoFlavorNoTimeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TotalNoFlavorNoTimeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorZJetUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorZJetDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPhotonJetUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPhotonJetDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureGluonUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureGluonDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureQuarkUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureQuarkDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureCharmUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureCharmDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureBottomUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_FlavorPureBottomDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunBCDUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunBCDDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunEFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunEFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunGUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunGDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunHUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_TimeRunHDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupMPFInSituUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupMPFInSituDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupIntercalibrationUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupIntercalibrationDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupbJESUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupbJESDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupFlavorUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupFlavorDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupUncorrelatedUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW1_corr_CorrelationGroupUncorrelatedDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteStatUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteStatDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteScaleUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteScaleDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteFlavMapUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteFlavMapDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteMPFBiasUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_AbsoluteMPFBiasDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FragmentationUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FragmentationDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SinglePionECALUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SinglePionECALDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SinglePionHCALUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SinglePionHCALDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorQCDUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorQCDDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimePtEtaUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimePtEtaDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeJEREC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeJEREC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeJEREC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeJEREC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeJERHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeJERHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtBBUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtBBDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtEC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtEC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtEC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtEC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativePtHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeBalUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeBalDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeFSRUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeFSRDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeStatFSRUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeStatFSRDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeStatECUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeStatECDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeStatHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_RelativeStatHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpDataMCUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpDataMCDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtRefUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtRefDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtBBUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtBBDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtEC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtEC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtEC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtEC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpPtHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpMuZeroUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpMuZeroDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpEnvelopeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_PileUpEnvelopeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalPileUpUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalPileUpDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalRelativeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalRelativeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalPtUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalPtDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalScaleUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalScaleDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalAbsoluteUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalAbsoluteDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalMCUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_SubTotalMCDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalNoFlavorUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalNoFlavorDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalNoTimeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalNoTimeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalNoFlavorNoTimeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TotalNoFlavorNoTimeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorZJetUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorZJetDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPhotonJetUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPhotonJetDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureGluonUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureGluonDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureQuarkUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureQuarkDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureCharmUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureCharmDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureBottomUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_FlavorPureBottomDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunBCDUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunBCDDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunEFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunEFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunGUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunGDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunHUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_TimeRunHDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupMPFInSituUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupMPFInSituDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupIntercalibrationUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupIntercalibrationDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupbJESUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupbJESDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupFlavorUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupFlavorDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupUncorrelatedUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjW2_corr_CorrelationGroupUncorrelatedDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteStatUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteStatDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteScaleUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteScaleDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteFlavMapUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteFlavMapDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteMPFBiasUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_AbsoluteMPFBiasDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FragmentationUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FragmentationDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SinglePionECALUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SinglePionECALDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SinglePionHCALUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SinglePionHCALDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorQCDUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorQCDDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimePtEtaUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimePtEtaDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeJEREC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeJEREC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeJEREC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeJEREC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeJERHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeJERHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtBBUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtBBDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtEC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtEC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtEC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtEC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativePtHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeBalUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeBalDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeFSRUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeFSRDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeStatFSRUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeStatFSRDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeStatECUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeStatECDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeStatHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_RelativeStatHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpDataMCUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpDataMCDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtRefUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtRefDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtBBUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtBBDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtEC1Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtEC1Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtEC2Up[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtEC2Down[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtHFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpPtHFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpMuZeroUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpMuZeroDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpEnvelopeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_PileUpEnvelopeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalPileUpUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalPileUpDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalRelativeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalRelativeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalPtUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalPtDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalScaleUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalScaleDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalAbsoluteUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalAbsoluteDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalMCUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_SubTotalMCDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalNoFlavorUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalNoFlavorDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalNoTimeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalNoTimeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalNoFlavorNoTimeUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TotalNoFlavorNoTimeDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorZJetUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorZJetDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPhotonJetUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPhotonJetDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureGluonUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureGluonDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureQuarkUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureQuarkDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureCharmUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureCharmDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureBottomUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_FlavorPureBottomDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunBCDUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunBCDDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunEFUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunEFDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunGUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunGDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunHUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_TimeRunHDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupMPFInSituUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupMPFInSituDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupIntercalibrationUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupIntercalibrationDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupbJESUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupbJESDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupFlavorUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupFlavorDown[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupUncorrelatedUp[8];   //[nhttCandidates]
   Float_t         httCandidates_sjNonW_corr_CorrelationGroupUncorrelatedDown[8];   //[nhttCandidates]
   Int_t           nGenTop;
   ...
   Float_t         Jet_rawPtAfterSmearing[23];   //[nJet]
   Int_t           Jet_idxFirstTauMatch[23];   //[nJet]
   Int_t           Jet_heppyFlavour[23];   //[nJet]
   Float_t         Jet_ctagVsL[23];   //[nJet]
   Float_t         Jet_ctagVsB[23];   //[nJet]
   ...
   Float_t         Jet_btagDeepCSVdusg[23];   //[nJet]
   Float_t         Jet_btagDeepCSVb[23];   //[nJet]
   Float_t         Jet_btagDeepCSVc[23];   //[nJet]
   Float_t         Jet_btagDeepCSVbb[23];   //[nJet]
   Float_t         Jet_btagDeepCMVAdusg[23];   //[nJet]
   Float_t         Jet_btagDeepCMVAb[23];   //[nJet]
   Float_t         Jet_btagDeepCMVAc[23];   //[nJet]
   Float_t         Jet_btagDeepCMVAbb[23];   //[nJet]
   Float_t         Jet_btagCSVV0[23];   //[nJet]
   Float_t         Jet_btagCMVAV2[23];   //[nJet]
   ...
   Int_t           Jet_btagCmvaIdx[23];   //[nJet]
   Int_t           Jet_mcIdx[23];   //[nJet]
   Float_t         Jet_blike_VBF[23];   //[nJet]
   Float_t         Jet_pt_puppi[23];   //[nJet]
   Float_t         Jet_energyRing_dR0_em[23];   //[nJet]
   Float_t         Jet_energyRing_dR1_em[23];   //[nJet]
   Float_t         Jet_energyRing_dR2_em[23];   //[nJet]
   Float_t         Jet_energyRing_dR3_em[23];   //[nJet]
   Float_t         Jet_energyRing_dR4_em[23];   //[nJet]
   Float_t         Jet_energyRing_dR5_em[23];   //[nJet]
   Float_t         Jet_energyRing_dR0_mu[23];   //[nJet]
   Float_t         Jet_energyRing_dR1_mu[23];   //[nJet]
   Float_t         Jet_energyRing_dR2_mu[23];   //[nJet]
   Float_t         Jet_energyRing_dR3_mu[23];   //[nJet]
   Float_t         Jet_energyRing_dR4_mu[23];   //[nJet]
   Float_t         Jet_energyRing_dR5_mu[23];   //[nJet]
   Float_t         Jet_energyRing_dR0_ch[23];   //[nJet]
   Float_t         Jet_energyRing_dR1_ch[23];   //[nJet]
   Float_t         Jet_energyRing_dR2_ch[23];   //[nJet]
   Float_t         Jet_energyRing_dR3_ch[23];   //[nJet]
   Float_t         Jet_energyRing_dR4_ch[23];   //[nJet]
   Float_t         Jet_energyRing_dR5_ch[23];   //[nJet]
   Float_t         Jet_energyRing_dR0_neut[23];   //[nJet]
   Float_t         Jet_energyRing_dR1_neut[23];   //[nJet]
   Float_t         Jet_energyRing_dR2_neut[23];   //[nJet]
   Float_t         Jet_energyRing_dR3_neut[23];   //[nJet]
   Float_t         Jet_energyRing_dR4_neut[23];   //[nJet]
   Float_t         Jet_energyRing_dR5_neut[23];   //[nJet]
   Int_t           Jet_numDaughters_pt03[23];   //[nJet]
   Float_t         Jet_rawEnergy[23];   //[nJet]
   Float_t         Jet_pt_reg[23];   //[nJet]
   Float_t         Jet_pt_regVBF[23];   //[nJet]
   Float_t         Jet_pt_reg_corrJECUp[23];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJECUp[23];   //[nJet]
   Float_t         Jet_pt_reg_corrJECDown[23];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJECDown[23];   //[nJet]
   Float_t         Jet_pt_reg_corrJERUp[23];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJERUp[23];   //[nJet]
   Float_t         Jet_pt_reg_corrJERDown[23];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJERDown[23];   //[nJet]
   Float_t         Jet_btagCSVL_SF[23];   //[nJet]
   Float_t         Jet_btagCSVL_SF_up[23];   //[nJet]
   Float_t         Jet_btagCSVL_SF_down[23];   //[nJet]
   Float_t         Jet_btagCSVM_SF[23];   //[nJet]
   Float_t         Jet_btagCSVM_SF_up[23];   //[nJet]
   Float_t         Jet_btagCSVM_SF_down[23];   //[nJet]
   Float_t         Jet_btagCSVT_SF[23];   //[nJet]
   Float_t         Jet_btagCSVT_SF_up[23];   //[nJet]
   Float_t         Jet_btagCSVT_SF_down[23];   //[nJet]
   Float_t         Jet_btagWeightCSV[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_jes[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_jes[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_lf[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_lf[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_hf[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_hf[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_hfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_hfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_hfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_hfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_lfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_lfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_lfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_lfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_cferr1[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_cferr1[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_cferr2[23];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_cferr2[23];   //[nJet]
   Float_t         Jet_btagCMVAV2L_SF[23];   //[nJet]
   Float_t         Jet_btagCMVAV2L_SF_up[23];   //[nJet]
   Float_t         Jet_btagCMVAV2L_SF_down[23];   //[nJet]
   Float_t         Jet_btagCMVAV2M_SF[23];   //[nJet]
   Float_t         Jet_btagCMVAV2M_SF_up[23];   //[nJet]
   Float_t         Jet_btagCMVAV2M_SF_down[23];   //[nJet]
   Float_t         Jet_btagCMVAV2T_SF[23];   //[nJet]
   Float_t         Jet_btagCMVAV2T_SF_up[23];   //[nJet]
   Float_t         Jet_btagCMVAV2T_SF_down[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_jes[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_jes[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_lf[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_lf[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_hf[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_hf[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_hfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_hfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_hfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_hfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_lfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_lfstats1[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_lfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_lfstats2[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_cferr1[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_cferr1[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_cferr2[23];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_cferr2[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteStatUp[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteStatDown[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteScaleUp[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteScaleDown[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteFlavMapUp[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteFlavMapDown[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteMPFBiasUp[23];   //[nJet]
   Float_t         Jet_corr_AbsoluteMPFBiasDown[23];   //[nJet]
   Float_t         Jet_corr_FragmentationUp[23];   //[nJet]
   Float_t         Jet_corr_FragmentationDown[23];   //[nJet]
   Float_t         Jet_corr_SinglePionECALUp[23];   //[nJet]
   Float_t         Jet_corr_SinglePionECALDown[23];   //[nJet]
   Float_t         Jet_corr_SinglePionHCALUp[23];   //[nJet]
   Float_t         Jet_corr_SinglePionHCALDown[23];   //[nJet]
   Float_t         Jet_corr_FlavorQCDUp[23];   //[nJet]
   Float_t         Jet_corr_FlavorQCDDown[23];   //[nJet]
   Float_t         Jet_corr_TimePtEtaUp[23];   //[nJet]
   Float_t         Jet_corr_TimePtEtaDown[23];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC1Up[23];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC1Down[23];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC2Up[23];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC2Down[23];   //[nJet]
   Float_t         Jet_corr_RelativeJERHFUp[23];   //[nJet]
   Float_t         Jet_corr_RelativeJERHFDown[23];   //[nJet]
   Float_t         Jet_corr_RelativePtBBUp[23];   //[nJet]
   Float_t         Jet_corr_RelativePtBBDown[23];   //[nJet]
   Float_t         Jet_corr_RelativePtEC1Up[23];   //[nJet]
   Float_t         Jet_corr_RelativePtEC1Down[23];   //[nJet]
   Float_t         Jet_corr_RelativePtEC2Up[23];   //[nJet]
   Float_t         Jet_corr_RelativePtEC2Down[23];   //[nJet]
   Float_t         Jet_corr_RelativePtHFUp[23];   //[nJet]
   Float_t         Jet_corr_RelativePtHFDown[23];   //[nJet]
   Float_t         Jet_corr_RelativeBalUp[23];   //[nJet]
   Float_t         Jet_corr_RelativeBalDown[23];   //[nJet]
   Float_t         Jet_corr_RelativeFSRUp[23];   //[nJet]
   Float_t         Jet_corr_RelativeFSRDown[23];   //[nJet]
   Float_t         Jet_corr_RelativeStatFSRUp[23];   //[nJet]
   Float_t         Jet_corr_RelativeStatFSRDown[23];   //[nJet]
   Float_t         Jet_corr_RelativeStatECUp[23];   //[nJet]
   Float_t         Jet_corr_RelativeStatECDown[23];   //[nJet]
   Float_t         Jet_corr_RelativeStatHFUp[23];   //[nJet]
   Float_t         Jet_corr_RelativeStatHFDown[23];   //[nJet]
   Float_t         Jet_corr_PileUpDataMCUp[23];   //[nJet]
   Float_t         Jet_corr_PileUpDataMCDown[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtRefUp[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtRefDown[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtBBUp[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtBBDown[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC1Up[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC1Down[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC2Up[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC2Down[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtHFUp[23];   //[nJet]
   Float_t         Jet_corr_PileUpPtHFDown[23];   //[nJet]
   Float_t         Jet_corr_PileUpMuZeroUp[23];   //[nJet]
   Float_t         Jet_corr_PileUpMuZeroDown[23];   //[nJet]
   Float_t         Jet_corr_PileUpEnvelopeUp[23];   //[nJet]
   Float_t         Jet_corr_PileUpEnvelopeDown[23];   //[nJet]
   Float_t         Jet_corr_SubTotalPileUpUp[23];   //[nJet]
   Float_t         Jet_corr_SubTotalPileUpDown[23];   //[nJet]
   Float_t         Jet_corr_SubTotalRelativeUp[23];   //[nJet]
   Float_t         Jet_corr_SubTotalRelativeDown[23];   //[nJet]
   Float_t         Jet_corr_SubTotalPtUp[23];   //[nJet]
   Float_t         Jet_corr_SubTotalPtDown[23];   //[nJet]
   Float_t         Jet_corr_SubTotalScaleUp[23];   //[nJet]
   Float_t         Jet_corr_SubTotalScaleDown[23];   //[nJet]
   Float_t         Jet_corr_SubTotalAbsoluteUp[23];   //[nJet]
   Float_t         Jet_corr_SubTotalAbsoluteDown[23];   //[nJet]
   Float_t         Jet_corr_SubTotalMCUp[23];   //[nJet]
   Float_t         Jet_corr_SubTotalMCDown[23];   //[nJet]
   Float_t         Jet_corr_TotalUp[23];   //[nJet]
   Float_t         Jet_corr_TotalDown[23];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorUp[23];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorDown[23];   //[nJet]
   Float_t         Jet_corr_TotalNoTimeUp[23];   //[nJet]
   Float_t         Jet_corr_TotalNoTimeDown[23];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorNoTimeUp[23];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorNoTimeDown[23];   //[nJet]
   Float_t         Jet_corr_FlavorZJetUp[23];   //[nJet]
   Float_t         Jet_corr_FlavorZJetDown[23];   //[nJet]
   Float_t         Jet_corr_FlavorPhotonJetUp[23];   //[nJet]
   Float_t         Jet_corr_FlavorPhotonJetDown[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureGluonUp[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureGluonDown[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureQuarkUp[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureQuarkDown[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureCharmUp[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureCharmDown[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureBottomUp[23];   //[nJet]
   Float_t         Jet_corr_FlavorPureBottomDown[23];   //[nJet]
   Float_t         Jet_corr_TimeRunBCDUp[23];   //[nJet]
   Float_t         Jet_corr_TimeRunBCDDown[23];   //[nJet]
   Float_t         Jet_corr_TimeRunEFUp[23];   //[nJet]
   Float_t         Jet_corr_TimeRunEFDown[23];   //[nJet]
   Float_t         Jet_corr_TimeRunGUp[23];   //[nJet]
   Float_t         Jet_corr_TimeRunGDown[23];   //[nJet]
   Float_t         Jet_corr_TimeRunHUp[23];   //[nJet]
   Float_t         Jet_corr_TimeRunHDown[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupMPFInSituUp[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupMPFInSituDown[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupIntercalibrationUp[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupIntercalibrationDown[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupbJESUp[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupbJESDown[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupFlavorUp[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupFlavorDown[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupUncorrelatedUp[23];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupUncorrelatedDown[23];   //[nJet]
   Int_t           nFatjetCA15softdrop;
   Float_t         FatjetCA15softdrop_pt[8];   //[nFatjetCA15softdrop]
   Float_t         FatjetCA15softdrop_eta[8];   //[nFatjetCA15softdrop]
   Float_t         FatjetCA15softdrop_phi[8];   //[nFatjetCA15softdrop]
   Float_t         FatjetCA15softdrop_mass[8];   //[nFatjetCA15softdrop]
   ...
   Float_t         FatjetCA15subjetfiltered_pt[8];   //[nFatjetCA15subjetfiltered]
   Float_t         FatjetCA15subjetfiltered_eta[8];   //[nFatjetCA15subjetfiltered]
   Float_t         FatjetCA15subjetfiltered_phi[8];   //[nFatjetCA15subjetfiltered]
   Float_t         FatjetCA15subjetfiltered_mass[8];   //[nFatjetCA15subjetfiltered]
   ...
   heppy3(TString filename="");
   virtual ~heppy3();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TString filename="");
   virtual void     Loop(TString outputfilename="nfile.root");
...
#ifdef heppy3_cxx
heppy3::heppy3(TString filename) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
  // if (tree == 0) {
  //    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_higgs/vbfHbb/V25/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/VHBB_HEPPY_V25_energyRings/180312_125843/0000/tree_1.root");
   //   if (!f || !f->IsOpen()) {
   //      f = new TFile("/eos/cms/store/group/phys_higgs/vbfHbb/V25/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/VHBB_HEPPY_V25_energyRings/180312_125843/0000/tree_1.root");
   //   }
...
void heppy3::AddFile(TString filename)
{
	file_name = filename;
...
Int_t heppy3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t heppy3::LoadTree(Long64_t entry)
{
...
void heppy3::Init(TString filename)
{
...
void heppy3::Show(Long64_t entry)
{
...
Int_t heppy3::Cut(Long64_t entry)
{
