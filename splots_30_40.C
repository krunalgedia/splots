...
void AddModel(RooWorkspace* ws)
{
    ...
    RooRealVar Jet_pt("Jet_pt","Jet_pt",30,40);
    ...
    cout<<data_set->sumEntries()<<"data_set.sumEntries()"<<endl;
    ...
    cout<<mc_truth_sig->sumEntries()<<"mc_truth_sig.sumEntries()"<<endl;
...
//    r_totalPdf.fitTo(r_data_set,Extended());
    ...
    cout<<data_set_sig->sumEntries()<<"data_set_sig->sumEntries()"<<endl;
    ...
    cout<<p_data_set_sig->sumEntries()<<"p_data_set_sig->sumEntries()"<<endl;
    ...
    cout<<r_data_set_sig->sumEntries()<<"r_data_set_sig->sumEntries()"<<endl;
    ...
    cout<<p_r_data_set_sig->sumEntries()<<"p_r_data_set_sig->sumEntries()"<<endl;
...
//Make TTrees of the datasets used
    ...
    TFile* qreg_file = new TFile("qreg_file_30_40.root","RECREATE");
...
//    gPad->SetTickx();
    ...
    r_h1c->GetXaxis()->SetTitleOffset(0.85);
...
//    gPad->SetTicky();
    ...
    d1->GetXaxis()->SetTitleOffset(0.85);
...
//    gPad->SetTicky();
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_30_40/splots/";
    string ud1 = "_1";
    string ud2 = "_2";
    string png = ".png";
    string compo;
...

{
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_30_40/sweights/";
    string png = ".png";
    string compo;
...

{
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_30_40/bdt_sweights/";
    string png = ".png";
    string compo;
