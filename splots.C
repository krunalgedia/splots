...
void AddModel(RooWorkspace* ws)
{
    ...
    RooRealVar evt("evt","evt",-200,999999999999999);
    RooRealVar run("run","run",-200,999999999999999);
    RooRealVar lumi("lumi","lumi",-200,999999999999999);
    RooRealVar evt_copy("evt_copy","evt_copy",-200,999999999999999);
    RooRealVar run_copy("run_copy","run_copy",-200,999999999999999);
    RooRealVar lumi_copy("lumi_copy","lumi_copy",-200,999999999999999);


    RooRealVar Jet_leptonDeltaR("Jet_leptonDeltaR","Jet_leptonDeltaR",-105,5);
    RooRealVar Jet_mass("Jet_mass","Jet_mass",0,30000);
    RooRealVar Jet_pt("Jet_pt","Jet_pt",0,99999999);
    ...
    var_set.add(run);
    var_set.add(lumi);
    var_set.add(evt_copy);
    var_set.add(run_copy);
    var_set.add(lumi_copy);
    ...
    r_var_set.add(run);
    r_var_set.add(lumi);
    r_var_set.add(evt_copy);
    r_var_set.add(run_copy);
    r_var_set.add(lumi_copy);
...
//Make TTrees of the datasets used
    ...
    TFile* qreg_file = new TFile("qreg_file.root","RECREATE");
...
//    gPad->SetTicky();
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_all/splots/";
    string ud1 = "_1";
    string ud2 = "_2";
    string png = ".png";
    string compo;
...

{
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_all/sweights/";
    string png = ".png";
    string compo;
...

{
    ...
    string addr = "/mnt/t3nfs01/data01/shome/krgedia/Workspace/lxplus/splots_pt_all/bdt_sweights/";
    string png = ".png";
    string compo;
